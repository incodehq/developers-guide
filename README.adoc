...
The modules that currently make up Estatio (ECP) are shown  link::https://raw.githubusercontent.com/incodehq/developers-guide/master/images/estatio-ecp.png[in this diagram], rendered from this PlantUML source (via asciidoctor-diagram):
...
The modules that currently make up Estatio can be found link::https://raw.githubusercontent.com/incodehq/developers-guide/master/images/estatio-modules.png[in this diagram], rendered from the following PlantUML source (via asciidoctor-diagram):
...
The modules that make up Incode Catalog and the Isis Addons can be found link::https://raw.githubusercontent.com/incodehq/developers-guide/master/images/incode-and-isisaddons.png[in this diagram], rendered from the following PlantUML source (via asciidoctor-diagram):
